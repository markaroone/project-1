...
import styles from './DailyHydrationGraph.module.css';
...
const DailyHydrationGraph = () => {
  ...
  const getDataThisWeek = async () => {
    const {
      ...
      `http://localhost:8000/api/v1/hydration-records?date[lte]=${endOfWeek}&date[gte]=${startOfWeek}&sort=-date`
    );
...
export default DailyHydrationGraph;
